...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Kelola semua pesanan yang masuk dari pembeli</p>
    </div>
    ...
    @if ($orders && count($orders) > 0)
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 mb-6" x-data="{ status: 'all' }">
            ...
            <div class="flex gap-2 mt-3 flex-wrap">
                ...
                <button @click="status = 'shipped'" :class="status === 'shipped' ? 'bg-orange-600 text-white' : 'bg-gray-200 text-gray-800'" class="px-4 py-2 rounded-lg text-sm font-medium transition">
                    Sudah Dikirim
                </button>
    ...
    @else
        ...
        <div class="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <h3 class="mt-2 text-lg font-semibold text-gray-900">Belum ada pesanan</h3>
            <p class="mt-1 text-gray-600">Pesanan pembeli akan muncul di sini</p>
        </div>
    @endif
</div>
</x-layouts.app>
